<div class="modal draggable fade" id="delete-item" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">{{ __('messages.adm_title.delete', ['name' => 'Member']) }}</label>
            ...
            <div class="modal-body" style="background-color: #303030; color: #ffcc00; font-size: 1.3em;">
                <div class="container col-sm-11" id="deleteBody">
                    {!! trans('messages.adm_table.fake_delete') !!}
                </div>
            </div>
