    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">{{ __('messages.adm_title.show', ['name' => 'Relation']) }}</label>
            ...
            <div class="modal-body" style="background-color: #e0e0e0;">
                <div class="container col-sm-11" id="showBody">
                    <div class="row py-2">
                        <div class="col-sm-3 text-right py-2">{{ __('messages.adm_table.parent_member') }}</div>
                        <div class="col-sm-9 rounded bg-light py-2"><span class="align-middle" name="parent_txt"></span></div>
                    </div>
                    <div class="row py-2">
                        <div class="col-sm-3 text-right py-2">{{ __('messages.adm_table.child_member') }}</div>
                        <div class="col-sm-9 rounded bg-light py-2"><span class="align-middle" name="child_txt"></span></div>
                    </div>
                    <div class="row py-2">
                        <div class="col-sm-3 text-right py-2">{{ __('messages.adm_table.relation_name') }}</div>
