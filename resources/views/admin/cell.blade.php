...
<div class='container p-4'>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div id="leftToolbar">
                <div class='form-inline'>
                    <label class="form-control" style="background-color: #3366ff; color: #ffffff;">Unassigned Member</label>
                </div>
            </div>
        ...
        <div class="col-sm-2 py-5 px-4" style="height: 400px;">
            <div class="row">
                <button id="toRightMember" type="button" class="toRight btn btn-warning mt-5 form-control" title="To the Right">As a Member<i class="fa fa-arrow-right ml-2"></i></button>
            </div>
            <div class="row">
                <button id="toRightManager" type="button" class="toRight btn btn-warning mt-2 form-control" title="To the Right">As a Manager<i class="fa fa-arrow-right ml-2"></i></button>
            </div>
            <div class="row">
                <button type="button" class="toLeft btn btn-info mt-5 form-control" title="To the Left"><i class="fa fa-arrow-left mr-2"></i>Leave</button>
            </div>
        </div>
        <div class="col-sm-5">
            <div id="rightToolbar" class="row py-2">
                ...
                <div class='form-inline col-sm-6 justify-content-end'>
                    <label class="form-control" style="background-color:#039023; color: #ffffff;">Assigned Member</label>
                </div>
            </div>
