...
<div class='container p-4'>
    ...
    <table  id="table" class="table table-striped table-bordered" 
        ...
        <thead>
            <tr>
                ...
                <th data-field="txt" data-width="15%" data-filter-control="select" data-sortable="true" scope="col">{{ __('messages.adm_table.privilege_name') }}</th>
    ...
    @include('admin.includes.privileges.create')
    @include('admin.includes.privileges.edit')
    @include('admin.includes.privileges.show')
    @include('admin.includes.privileges.delete')
        ...
        function reloadList() {
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) { // What to do if we fail
                    toastr.error("can't get privileges data from server: " + JSON.stringify(jqXHR), Failed);
                }
            });
        }  
