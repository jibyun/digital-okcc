    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">Add Codes</label>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="background-color: #e0e0e0;">
                <table  id="addTable" class="table table-dark table-bordered table-hover table-responsive-md table-striped px-3" 
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="txt" data-width="35%" data-filter-control="select" data-sortable="false" scope="col">Code Name</th>
