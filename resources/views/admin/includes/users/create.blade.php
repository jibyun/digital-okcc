    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">{{ __('messages.adm_title.create', ['name' => 'User']) }}</label>
            ...
            <div class="modal-body" style="background-color: #e0e0e0;">
                <form id="createForm" class="px-3" action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select id="createMemberCombo" class="form-control" name="members" data-placeholder="{{ __('messages.adm_table.select_member') }}">
                            </select>
                        </div>
                    </div>
                    {{-- Privilege  --}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select id="createPrivilegeCombo" class="form-control" name="privileges" data-placeholder="{{ __('messages.adm_table.select_privilege') }}">
                            </select>
                        </div>
                    </div>
                    {{-- Buttons --}}
