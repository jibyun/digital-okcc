    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">{{ __('messages.adm_title.edit', ['name' => 'Privilege']) }}</label>
            ...
            <div class="modal-body" style="background-color: #e0e0e0;">
                <form id="editForm" class="px-3" action='' method="PUT">
                    ...
                    <div class="form-group row">
                        <label for="txt" class="col-sm-3 col-form-label text-right">{{ __('messages.adm_table.privilege_name') }}</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="txt" name="txt" placeholder="{{ __('messages.adm_table.privilege_name') }}">
                        </div>
                    </div>
                    {{--  Remark  --}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="ckeditor-edit" name="memo" placeholder="{{ __('messages.adm_table.memo') }}"></textarea>
                        </div>
                    </div>
                    {{-- Buttons --}}
