    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" id="myModalLabel">
                <label class="modal-title h6-font-size" style="font-weight: 600">Upload a Photo</label>
            ...
            <div class="modal-body" style="background-color: #e0e0e0;">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <button class="btn btn-success upload-result form-control"><i class="fa fa-upload mr-3" aria-hidden="true"></i>Upload Image</button>
                    </div>
                </div>
            </div>
        </div>
