    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #e0e0e0;">
                <table  id="addTable" class="table table-dark table-bordered table-hover table-responsive-md table-striped s1-font-size" 
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="txt" data-width="20%" data-filter-control="select" data-sortable="false" scope="col">Role Name</th>
                            <th data-field="memo" data-sortable="false" scope="col">Memo</th>
                        </tr>
                    </thead>
                </table>
                {{-- Buttons --}}
