<div class="collapse show" id="showPanel">
    <div>
            <button title="ToList" class="btn btn-secondary" id="ToListBtn" type="button">
                     To List
                </button>
    </div>
        ...
        <div class="col-md-6 p-0">
            ...
            <div class="row m-3">
                <div class="col-12 pr-0 text-right">
                    ...
                    <button title="Delete Member" class="btn btn-danger ml-2" id="deleteRecordButton" type="button">
